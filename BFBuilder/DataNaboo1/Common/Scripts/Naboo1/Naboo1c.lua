...
--end header
--start objectives
AddMissionObjective(REP,"red", "level.Naboo1.objectives.1");
AddMissionObjective(REP,"orange", "level.Naboo1.objectives.2");
AddMissionObjective(REP,"orange", "level.Naboo1.objectives.3");
AddMissionObjective(CIS,"red", "level.Naboo1.objectives.1");
AddMissionObjective(CIS,"orange", "level.Naboo1.objectives.2");
AddMissionObjective(CIS,"orange","level.Naboo1.objectives.3");
--end objectives
--start soundlvl
...
--end memorypools
--start worldlvl
ReadDataFile("dc:Naboo1\\Naboo1.lvl")
--end worldlvl
--start spawndelay
