...
--end header
--start objectives
AddMissionObjective(REP,"red", "level.Tatooine2.objectives.1");
AddMissionObjective(REP,"orange", "level.Tatooine2.objectives.2");
AddMissionObjective(REP,"orange", "level.Tatooine2.objectives.3");
AddMissionObjective(CIS,"red", "level.Tatooine2.objectives.1");
AddMissionObjective(CIS,"orange", "level.Tatooine2.objectives.2");
AddMissionObjective(CIS,"orange","level.Tatooine2.objectives.3");
--end objectives
--start soundlvl
...
--end memorypools
--start worldlvl
ReadDataFile("dc:Tatooine2\\Tatooine2.lvl")
--end worldlvl
--start spawndelay
