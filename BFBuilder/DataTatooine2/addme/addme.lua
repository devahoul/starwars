...
local newEntry = { mapluafile = "Tatooine2", showstr = "Z Tatooine 2",  side_a = 1, dnldable = 1, }
...
AddDownloadableContent("Tatooine2","Tatooine2c",4)
AddDownloadableContent("Tatooine2","Tatooine2a",4)
