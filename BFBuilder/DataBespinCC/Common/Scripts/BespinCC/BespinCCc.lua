...
--end header
--start objectives
AddMissionObjective(REP,"red", "level.BespinCC.objectives.1");
AddMissionObjective(REP,"orange", "level.BespinCC.objectives.2");
AddMissionObjective(REP,"orange", "level.BespinCC.objectives.3");
AddMissionObjective(CIS,"red", "level.BespinCC.objectives.1");
AddMissionObjective(CIS,"orange", "level.BespinCC.objectives.2");
AddMissionObjective(CIS,"orange","level.BespinCC.objectives.3");
--end objectives
--start soundlvl
...
--end memorypools
--start worldlvl
ReadDataFile("dc:BespinCC\\BespinCC.lvl")
--end worldlvl
--start spawndelay
