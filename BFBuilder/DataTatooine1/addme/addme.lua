...
local newEntry = { mapluafile = "Tatooine1", showstr = "Z Tatooine 1",  side_a = 1, dnldable = 1, }
...
AddDownloadableContent("Tatooine1","Tatooine1c",4)
AddDownloadableContent("Tatooine1","Tatooine1a",4)
