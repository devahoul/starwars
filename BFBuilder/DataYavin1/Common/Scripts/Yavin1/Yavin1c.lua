...
--end header
--start objectives
AddMissionObjective(REP,"red", "level.Yavin1.objectives.1");
AddMissionObjective(REP,"orange", "level.Yavin1.objectives.2");
AddMissionObjective(REP,"orange", "level.Yavin1.objectives.3");
AddMissionObjective(CIS,"red", "level.Yavin1.objectives.1");
AddMissionObjective(CIS,"orange", "level.Yavin1.objectives.2");
AddMissionObjective(CIS,"orange","level.Yavin1.objectives.3");
--end objectives
--start soundlvl
...
--end memorypools
--start worldlvl
ReadDataFile("dc:Yavin1\\Yavin1.lvl")
--end worldlvl
--start spawndelay
