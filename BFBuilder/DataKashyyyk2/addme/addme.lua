...
local newEntry = { mapluafile = "Kashyyyk2", showstr = "Z Kashyyyk 2",  side_a = 1, dnldable = 1, }
...
AddDownloadableContent("Kashyyyk2","Kashyyyk2c",4)
AddDownloadableContent("Kashyyyk2","Kashyyyk2a",4)
