...
--end header
--start objectives
AddMissionObjective(REP,"red", "level.Kashyyyk2.objectives.1");
AddMissionObjective(REP,"orange", "level.Kashyyyk2.objectives.2");
AddMissionObjective(REP,"orange", "level.Kashyyyk2.objectives.3");
AddMissionObjective(CIS,"red", "level.Kashyyyk2.objectives.1");
AddMissionObjective(CIS,"orange", "level.Kashyyyk2.objectives.2");
AddMissionObjective(CIS,"orange","level.Kashyyyk2.objectives.3");
--end objectives
--start soundlvl
...
--end memorypools
--start worldlvl
ReadDataFile("dc:Kashyyyk2\\Kashyyyk2.lvl")
--end worldlvl
--start spawndelay
