...
--end header
--start objectives
AddMissionObjective(REP,"red", "level.Rhenvar2.objectives.1");
AddMissionObjective(REP,"orange", "level.Rhenvar2.objectives.2");
AddMissionObjective(REP,"orange", "level.Rhenvar2.objectives.3");
AddMissionObjective(CIS,"red", "level.Rhenvar2.objectives.1");
AddMissionObjective(CIS,"orange", "level.Rhenvar2.objectives.2");
AddMissionObjective(CIS,"orange","level.Rhenvar2.objectives.3");
--end objectives
--start soundlvl
...
--end memorypools
--start worldlvl
ReadDataFile("dc:Rhenvar2\\Rhenvar2.lvl")
--end worldlvl
--start spawndelay
