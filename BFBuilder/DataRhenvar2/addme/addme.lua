...
local newEntry = { mapluafile = "Rhenvar2", showstr = "Z Rhen Var 2",  side_a = 1, dnldable = 1, }
...
AddDownloadableContent("Rhenvar2","Rhenvar2c",4)
AddDownloadableContent("Rhenvar2","Rhenvar2a",4)
