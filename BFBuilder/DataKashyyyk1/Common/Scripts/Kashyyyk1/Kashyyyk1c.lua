...
--end header
--start objectives
AddMissionObjective(REP,"red", "level.Kashyyyk1.objectives.1");
AddMissionObjective(REP,"orange", "level.Kashyyyk1.objectives.2");
AddMissionObjective(REP,"orange", "level.Kashyyyk1.objectives.3");
AddMissionObjective(CIS,"red", "level.Kashyyyk1.objectives.1");
AddMissionObjective(CIS,"orange", "level.Kashyyyk1.objectives.2");
AddMissionObjective(CIS,"orange","level.Kashyyyk1.objectives.3");
--end objectives
--start soundlvl
...
--end memorypools
--start worldlvl
ReadDataFile("dc:Kashyyyk1\\Kashyyyk1.lvl")
--end worldlvl
--start spawndelay
