...
local newEntry = { mapluafile = "Kashyyyk1", showstr = "Z Kashyyyk 1",  side_a = 1, dnldable = 1, }
...
AddDownloadableContent("Kashyyyk1","Kashyyyk1c",4)
AddDownloadableContent("Kashyyyk1","Kashyyyk1a",4)
