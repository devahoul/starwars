        ...
        ParticleEmitter("Flames")
        {
            ...
            ParticleEmitter("SmokeTrail")
            {
                ...
                Spawner()
                {
                    Circle()
                    {
                        PositionX(-0.9600,0.9600);
                        PositionY(0.9600,1.9200);
                        PositionZ(-0.9600,0.9600);
                    }
                    Offset()
                    {
                        PositionX(0.0000,0.0000);
                ...
                Transformer()
                {
                    ...
                    {
                        LifeTime(4.0000)
                        Accelerate(0.0000, -19.2000, 0.0000);
                    }
                    Size(0)
                    {
                        LifeTime(5.0000)
                ...
                Geometry()
                {
                    ...
                    ParticleEmitter("Smoke")
                    {
                        ...
                        Spawner()
                        {
                            ...
                            PositionScale(0.0000,0.0000);
                            VelocityScale(0.0960,0.0960);
                            InheritVelocityFactor(0.2500,0.2500);
                            Size(0, 0.1200, 0.3600);
                            Red(0, 255.0000, 255.0000);
                            Green(0, 255.0000, 255.0000);
                            Blue(0, 255.0000, 255.0000);
                            Alpha(0, 0.0000, 0.0000);
                        ...
                        Transformer()
                        {
                            ...
                            {
                                LifeTime(2.0000)
                                Accelerate(0.0000, 0.9600, 0.0000);
                            }
                            Size(0)
                            {
                                LifeTime(2.0000)
