...
--end header
--start objectives
AddMissionObjective(REP,"red", "level.Yavin2.objectives.1");
AddMissionObjective(REP,"orange", "level.Yavin2.objectives.2");
AddMissionObjective(REP,"orange", "level.Yavin2.objectives.3");
AddMissionObjective(CIS,"red", "level.Yavin2.objectives.1");
AddMissionObjective(CIS,"orange", "level.Yavin2.objectives.2");
AddMissionObjective(CIS,"orange","level.Yavin2.objectives.3");
--end objectives
--start soundlvl
...
--end memorypools
--start worldlvl
ReadDataFile("dc:Yavin2\\Yavin2.lvl")
--end worldlvl
--start spawndelay
