...
--end header
--start objectives
AddMissionObjective(REP,"red", "level.Naboo2.objectives.1");
AddMissionObjective(REP,"orange", "level.Naboo2.objectives.2");
AddMissionObjective(REP,"orange", "level.Naboo2.objectives.3");
AddMissionObjective(CIS,"red", "level.Naboo2.objectives.1");
AddMissionObjective(CIS,"orange", "level.Naboo2.objectives.2");
AddMissionObjective(CIS,"orange","level.Naboo2.objectives.3");
--end objectives
--start soundlvl
...
--end memorypools
--start worldlvl
ReadDataFile("dc:Naboo2\\Naboo2.lvl")
--end worldlvl
--start spawndelay
