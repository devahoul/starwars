...
--end header
--start objectives
AddMissionObjective(REP,"red", "level.Hoth.objectives.1");
AddMissionObjective(REP,"orange", "level.Hoth.objectives.2");
AddMissionObjective(REP,"orange", "level.Hoth.objectives.3");
AddMissionObjective(CIS,"red", "level.Hoth.objectives.1");
AddMissionObjective(CIS,"orange", "level.Hoth.objectives.2");
AddMissionObjective(CIS,"orange","level.Hoth.objectives.3");
--end objectives
--start soundlvl
