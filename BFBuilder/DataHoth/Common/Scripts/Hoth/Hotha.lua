...
--      Alliance Stats
    ...
    AddUnitClass(ALL, "all_inf_soldiersnow",40)
    AddUnitClass(ALL, "all_inf_vanguardsnow",15)
    AddUnitClass(ALL, "all_inf_pilot",15)
    AddUnitClass(ALL, "all_inf_marksmansnow",15)
    AddUnitClass(ALL, "all_inf_smugglersnow",15)
    SetHeroClass(ALL, "all_inf_lukeskywalkersnow")

--      Imperial Stats
    SetTeamName(IMP, "Empire")
    SetTeamIcon(IMP, "imp_icon")
    AddUnitClass(IMP, "imp_inf_storm_troopersnow",40)
    AddUnitClass(IMP, "imp_inf_shock_troopersnow",15)
    AddUnitClass(IMP, "imp_inf_pilotatat",15)
    AddUnitClass(IMP, "imp_inf_scout_troopersnow",15)
    AddUnitClass(IMP, "imp_inf_dark_troopersnow",15)
