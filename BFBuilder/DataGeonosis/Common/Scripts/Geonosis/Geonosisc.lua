...
--    Republic Stats
    ...
    AddUnitClass(REP, "rep_inf_arc_trooper",15)
    AddUnitClass(REP, "rep_inf_clone_pilot",15)
    AddUnitClass(REP, "rep_inf_clone_sharpshooter",15)
    AddUnitClass(REP, "rep_inf_jet_trooper",15)
...
--  CIS Stats
    ...
    AddUnitClass(CIS, "cis_inf_battledroid",40)
    AddUnitClass(CIS, "cis_inf_assault",15)
    AddUnitClass(CIS, "cis_inf_pilotdroid",15)
    AddUnitClass(CIS, "cis_inf_assassindroid",15)
    AddUnitClass(CIS, "cis_inf_droideka",15)
