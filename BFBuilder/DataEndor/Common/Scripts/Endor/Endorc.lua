...
--end header
--start objectives
AddMissionObjective(REP,"red", "level.Endor.objectives.1");
AddMissionObjective(REP,"orange", "level.Endor.objectives.2");
AddMissionObjective(REP,"orange", "level.Endor.objectives.3");
AddMissionObjective(CIS,"red", "level.Endor.objectives.1");
AddMissionObjective(CIS,"orange", "level.Endor.objectives.2");
AddMissionObjective(CIS,"orange","level.Endor.objectives.3");
--end objectives
--start soundlvl
...
--end memorypools
--start worldlvl
ReadDataFile("dc:Endor\\Endor.lvl")
--end worldlvl
--start spawndelay
