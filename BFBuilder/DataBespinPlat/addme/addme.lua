...
local newEntry = { mapluafile = "BespinPlat", showstr = "Z Bespin Platforms",  side_a = 1, dnldable = 1, }
...
AddDownloadableContent("BespinPlat","BespinPlatc",4)
AddDownloadableContent("BespinPlat","BespinPlata",4)
