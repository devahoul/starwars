...
--end header
--start objectives
AddMissionObjective(REP,"red", "level.BespinPlat.objectives.1");
AddMissionObjective(REP,"orange", "level.BespinPlat.objectives.2");
AddMissionObjective(REP,"orange", "level.BespinPlat.objectives.3");
AddMissionObjective(CIS,"red", "level.BespinPlat.objectives.1");
AddMissionObjective(CIS,"orange", "level.BespinPlat.objectives.2");
AddMissionObjective(CIS,"orange","level.BespinPlat.objectives.3");
--end objectives
--start soundlvl
...
--end memorypools
--start worldlvl
ReadDataFile("dc:BespinPlat\\BespinPlat.lvl")
--end worldlvl
--start spawndelay
