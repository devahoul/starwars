...
local newEntry = { mapluafile = "Rhenvar1", showstr = "Z Rhen Var 1",  side_a = 1, dnldable = 1, }
...
AddDownloadableContent("Rhenvar1","Rhenvar1c",4)
AddDownloadableContent("Rhenvar1","Rhenvar1a",4)
