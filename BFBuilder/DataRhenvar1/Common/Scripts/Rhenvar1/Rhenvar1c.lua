...
--end header
--start objectives
AddMissionObjective(REP,"red", "level.Rhenvar1.objectives.1");
AddMissionObjective(REP,"orange", "level.Rhenvar1.objectives.2");
AddMissionObjective(REP,"orange", "level.Rhenvar1.objectives.3");
AddMissionObjective(CIS,"red", "level.Rhenvar1.objectives.1");
AddMissionObjective(CIS,"orange", "level.Rhenvar1.objectives.2");
AddMissionObjective(CIS,"orange","level.Rhenvar1.objectives.3");
--end objectives
--start soundlvl
...
--end memorypools
--start worldlvl
ReadDataFile("dc:Rhenvar1\\Rhenvar1.lvl")
--end worldlvl
--start spawndelay
