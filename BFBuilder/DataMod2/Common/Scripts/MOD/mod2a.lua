...
--  These variables do not change
    ...
    AddMissionObjective(IMP, "red", "level.mod2.objectives.1");
    AddMissionObjective(IMP, "orange", "level.mod2.objectives.2");
    AddMissionObjective(IMP, "orange", "level.mod2.objectives.3");
    AddMissionObjective(ALL, "red", "level.mod2.objectives.1");
    AddMissionObjective(ALL, "orange", "level.mod2.objectives.2");
    AddMissionObjective(ALL, "orange", "level.mod2.objectives.3");
    
    SetMinFlyHeight(20)
    SetMaxFlyHeight(256)
    SetMaxPlayerFlyHeight(256)
...
--  Sound Stats
   ...
   -- OpenAudioStream("dc:sound\\mod.lvl",  "mod2");
    OpenAudioStream("sound\\gcw.lvl",  "gcw_vo");
    OpenAudioStream("sound\\gcw.lvl",  "gcw_tac_vo");
   --  OpenAudioStream("dc:sound\\mod.lvl",  "mod2_emt");
   --OpenAudioStream("dc:sound\\tat.lvl",  "mod2_emt");
