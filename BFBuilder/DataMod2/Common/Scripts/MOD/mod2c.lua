...
--  These variables do not change
    ...
    AddMissionObjective(CIS, "red", "level.mod2.objectives.1");
    AddMissionObjective(CIS, "orange", "level.mod2.objectives.2");
    AddMissionObjective(CIS, "orange", "level.mod2.objectives.3");
    AddMissionObjective(REP, "red", "level.mod2.objectives.1");
    AddMissionObjective(REP, "orange", "level.mod2.objectives.2");
    AddMissionObjective(REP, "orange", "level.mod2.objectives.3");
