...
REM Modder Change this to match new world name in path specified
cd Worlds
 cd MOD
  @call munge.bat
 cd ..
...
REM Modder Change this to match new world name for creation of add on folder
set PACKAGE_NUM=Mod2
...
REM Modders these lines can be changed to point to your SWBF Addon folder for faster testing
